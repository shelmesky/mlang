...
impl Operator {
    ...
    pub fn precedence(&self) -> usize {
        match self {
            ...
            Operator::Add | Operator::Sub | Operator::Or | Operator::Xor => 4,
            Operator::Star
            | Operator::Quo
            | Operator::Rem
            | Operator::Shl
...
pub(crate) trait IntoKind: Into<TokenKind> + Copy {}
impl<T: Into<TokenKind> + Copy> IntoKind for T {}
...
pub(crate) const RIGHTARROW: Token = Token::Operator(Operator::RightArrow);
...
pub(crate) const LET: Token = Token::Keyword(Keyword::Let);
...
pub(crate) const FUNC: Token = Token::Keyword(Keyword::Function);
